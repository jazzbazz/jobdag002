...
$query = "SELECT  id, vnaam, naam, antw1, antw2, antw3, antw4, check1, check2, check3, omschrijving, pad FROM jobdag.students  ";
...
echo '<input type="hidden" name="skil3" value="'.$skill3.'">';
